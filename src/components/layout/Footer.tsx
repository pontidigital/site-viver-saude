...
import { SITE, SOCIAL, NAV_ITEMS, APP_LINKS, WHATSAPP_URL } from "@/lib/constants/site";
        ...
        >
          ...
          <motion.div variants={columnVariants}>
            ...
            <ul className="space-y-3">
              <li>
                <a href={`tel:${SITE.phone}`} className="flex items-start gap-3 text-gray-400 hover:text-accent text-sm transition-colors">
          ...
          {/* Column 4: App + Social */}
          <motion.div variants={columnVariants}>
            <h3 className="text-white font-semibold mb-4">Baixe o App</h3>
            <div className="flex flex-col gap-3 mb-6">
              <a
                href={APP_LINKS.ios}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-white/10 hover:bg-white/20 rounded-lg px-4 py-2.5 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
                </svg>
                <div>
                  <p className="text-[10px] text-gray-400">Disponível na</p>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3.18 23.75L14.1 12.83 3.18.25c-.2-.2-.18-.6.13-.6h1.05c.14 0 .28.06.38.16l11.37 11.4c.22.22.22.58 0 .8L4.74 23.4c-.1.1-.24.16-.38.16H3.31c-.31 0-.33-.4-.13-.6v-.01z" />
                </svg>
                <div>
                  <p className="text-[10px] text-gray-400">Disponível no</p>
